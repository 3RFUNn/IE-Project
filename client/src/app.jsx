import { store, userSelector } from "./redux/store";
  ...
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      element: hasPermission ? (
        <DefaultLayout userType="itmanager" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
    ...
    },
    {
      path: "/student",
      element: hasPermission ? (
        <DefaultLayout userType="student" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
    ...
    },
    {
      path: "/edumanager",
      element: hasPermission ? (
        <DefaultLayout userType="edumanager" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
    ...
    },
    {
      ...
      element: hasPermission ? (
        <AddCourseForm userType="edumanager" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
    },
    {
      ...
      element: hasPermission ? (
        <RegisterdCourses userType="edumanager" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
    },
    {
      path: "/professor",
      element: hasPermission ? (
        <DefaultLayout userType="professor" />
      ) : (
        <Navigate to="/login" />
      ),
      errorElement: <div></div>,
