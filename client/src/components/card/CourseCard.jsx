...
const CourseCard = ({ cardData, type }) => {
  ...
  return (
    <div className="w-[320px] h-[70px] rounded-md flex flex-row items-center justify-between font-serif bg-gray-500">
      ...
      <div className="flex flex-row items-center justify-center">
        ...
        <button
          ...
          className="bg-gray-700 mx-2 px-2 rounded-md text-white"
        >
          حذف
        </button>
      </div>
