...
const EditTerm = () => {
  ...
  return (
    <div className="font-serif flex w-[100vw] flex-col items-center">
      <div className="border-b-[1px] border-gray-500 w-full p-5">
        ویرایش اطلاعات ترم پاییز 1401
      </div>
      <form className="flex flex-col items-start py-5 px-5 w-full">
        ...
        <div className="flex flex-row items-center">
          ...
          <label
            htmlFor="file"
            className="bg-black text-white px-2 h-[40px] flex items-center mr-2"
          >
            آپلود اکسل
